            ...
            <div id="main-header" class="py-2 bg-light text-dark mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h1>
                                <i class="fas fa-user-cog"></i> Mascota
                            </h1>
                        </div>                                                
                    </div>                                         
                </div>                
        ...
        <main>
            ...
            <section id="accions" class="py-4 mb-4">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <a href="#" class="btn btn-primary">Agregar Mascota</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${data}" var="mascota">
                                        <tr>
                                            <td>${mascota.idMascota}</td>
                                            <td>${mascota.nombre}</td>
                                            <td>${mascota.tipoMascotaId}</td>
                                            <td>${mascota.raza}</td>
                                            <td>${mascota.genero}</td>
                                            <td>${mascota.edad}</td>
                                            <td>${mascota.salonId}</td>
                                            <td>
