            ...
            <div id="main-header" class="py-2 bg-light text-dark mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h1>
                                <i class="fas fa-user-cog"></i> Adopcion
                            </h1>
                        </div>                                                
                    </div>                                         
                </div>                
        ...
        <main>
            ...
            <section id="accions" class="py-4 mb-4">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <a href="#" class="btn btn-primary">Agregar Adopcion</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${data}" var="adopcion">
                                        <tr>
                                            <td>${adopcion.id}</td>
                                            <td>${adopcion.empleadoId}</td>
                                            <td>${adopcion.clienteId}</td>
                                            <td>${adopcion.mascotaId}</td>
                                            <td>${adopcion.fecha}</td>
                                            <td>
                                                <i class="fa fa-edit"></i> Editar
                                            </td>
                                            <td>
                                                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletAdopcion?accion=eliminar&id=${adopcion.id}">
