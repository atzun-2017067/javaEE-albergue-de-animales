            ...
            <div id="main-header" class="py-2 bg-light text-dark mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h1>
                                <i class="fas fa-user-cog"></i> Empleado
                            </h1>
                        </div>                                                
                    </div>                                         
                </div>                
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${data}" var="empleado">
                                        <tr>
                                            <td>${empleado.id}</td>
                                            <td>${empleado.personaId}</td>
                                            <td>${empleado.tipoEmpleado}</td>
                                            <td>
                                                <i class="fa fa-edit"></i> Editar
                                            </td>
                                            <td>
                                                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletEmpleado?accion=eliminar&id=${empleado.id}">
